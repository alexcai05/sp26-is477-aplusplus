...
Despite the volume of work we did for this project, there is still plenty of room to explore this topic, as suggested by our conclusions. As mentioned before, there are plenty of other factors that determine a student’s success including the resources they had, what major they chose, where they live, etc. All of these factors could be interesting to look into the correlations they have with earnings. Additionally, we only looked at earnings from an in-state tuition cost perspective. We didn’t use out of state tuition costs or factor in scholarships and financial aid or anything, all of which are variables that really matter to students when they select the college they wish to go to. A new study could absolutely have room to explore the correlations between those variables and post graduate earnings to discover the importance of financial aid.
